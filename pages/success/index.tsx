    ...
    <div>
      ...
      <main className="flex flex-col space-y-5 items-center justify-center min-h-screen max-h-screen py-10 sm:pb-20">
        ...
        <div className="flex flex-col text-center space-y-2">
          <SlackButton text="Open Slack" url={`https://mtdr-dev.slack.com/messages/${process.env.APP_ID}`}/>
          {/* <SlackButton text="Open Slack" url="slack://slack.com/app_redirect?app=A048FUETE57" /> */}

{/* https://slack.mtdr.dev */}
